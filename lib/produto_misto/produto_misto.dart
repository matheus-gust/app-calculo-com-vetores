...
class ProdutoMisto extends StatefulWidget {
  @override
  _ProdutoMistoState createState() => _ProdutoMistoState();
}

class _ProdutoMistoState extends State<ProdutoMisto> {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Center(
                                child: (this.resultado != null)
                                    ? Text(
                                        "O produto misto é: \n" +
                                            resultado.x.toStringAsFixed(2) +
                                            "i, " +
                                            resultado.y.toStringAsFixed(2) +
                                            "j, " +
                                            resultado.z.toStringAsFixed(2) +
                                            "k, ",
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            VetorModel vetor3 = VetorModel(
                                ...
                                z: double.tryParse(vetor3Z.text));
                            setState(() {
                              resultado =
                                  VetorModel.produtoMisto(vetor1, vetor2,vetor3);
                            });
                          },
                        ),
                      ),
