...
class SubtracaoVetores extends StatefulWidget {
  @override
  _SubtracaoVetoresState createState() => _SubtracaoVetoresState();
}

class _SubtracaoVetoresState extends State<SubtracaoVetores> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text("Subtração de vetores"),
        ),
        body: Padding(
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Center(child: (this.resultado != null) ? Text("O resultado é: " + resultado.x.toString() + ", " + resultado.y.toString() + ", " + resultado.z.toString(), style: TextStyle(fontSize: 25),) : Text("")),
                          ),
                        ),
                      ),
                      Container(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            setState(() {
                              resultado = VetorModel.subtrair(vetor1, vetor2, vetor3);
                            });
                          },
                        ),
                      ),
