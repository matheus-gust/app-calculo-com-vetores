...
class SomaVetores extends StatefulWidget {
  @override
  _SomaVetoresState createState() => _SomaVetoresState();
}

class _SomaVetoresState extends State<SomaVetores> {
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            setState(() {
                              resultado =
                                  VetorModel.somar(vetor1, vetor2, vetor3);
                            });
                          },
                        ),
                      ),
